...
%% Step 1: Define parameters 
    ...
    x_i_01pred = [0.047 0.1098 0.1501 0.4558 0.0937 0.2968 0.0741 0.0773 0.2213];
    x_i_05pred = [0.004 0.0059 0.0071 0.0188 0.0055 0.0116 0.0049 0.005 0.0091];
    x_i_1pred=[0.0026 0.0032 0.0035 0.0065 0.0030 0.0048 0.0028 0.0029 0.0041];
