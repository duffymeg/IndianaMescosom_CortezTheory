...
%           Step 4: Compute R0 and R values at each week and eco/evo effect sizes
...
% NOTE:     Only data for weeks 0 and 2 plotted/analyzed because predator
...
%% Step 1: Define parameters 
    ...
    xi_01pred = [0.047 0.1098 0.1501 0.4558 0.0937 0.2968 0.0741 0.0773 0.2213];
    xi_05pred = [0.004 0.0059 0.0071 0.0188 0.0055 0.0116 0.0049 0.005 0.0091];
    xi_1pred=[0.0026 0.0032 0.0035 0.0065 0.0030 0.0048 0.0028 0.0029 0.0041];
...
%% Step 6: Plot effect sizes for Ecology and Evolution
